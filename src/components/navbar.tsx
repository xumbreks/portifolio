export function Navbar() {
  ...
  return (
    <nav className="flex h-16 w-full justify-center items-center fixed">
      <div className="w-full flex justify-center items-center gap-10 lg:px-0 lg:max-w-screen-lg">
        <div className="text-lg lg:text-2xl font-bold px-2 hover:border-2 border-white rounded-full 
        transition-colors
      ...
      dark:hover:border-black">
        ...
        <div className="relative w-10 lg:w-16" onClick={toggleMode}>
          <button
